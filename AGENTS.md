...
4. As needed: [docs/DECISIONS.md](docs/DECISIONS.md) (binding decisions D1–D310), [docs/PRODUCT.md](docs/PRODUCT.md) (vision, competitive map, FREE/PRO), and [docs/RELEASING.md](docs/RELEASING.md) (the full release recipe — build/notarize/publish steps, commands, gotchas, title format).
