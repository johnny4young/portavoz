...
- **Correct the reading, keep the evidence** — fix a transcript line or its speaker from Meeting Detail without rewriting the accepted recording. Text and speaker corrections are durable, independently undoable, and keep the exact original line visible; summaries, search, and exports remain tied to accepted evidence until a later reviewed workflow explicitly adopts corrections.
