...
| `IntegrationsKit` | Gateway-only GitHub/Linear/Gist publishers, EventKit calendar, RAG, bundle/export, MCP, deterministic meeting-sync envelope encoding (no network yet), and the policy-checked, receipt-before-transport outbound network adapter |
