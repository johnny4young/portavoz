...
| `IntegrationsKit` | GitHub/Linear/Gist, calendar, RAG, bundle/export, and MCP adapters plus the remaining characterized Insights, brief, reminder, and mirror policies awaiting inward migration |
