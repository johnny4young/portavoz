...
Status: **approved direction; Bands 0–3 complete; slices 3A–3K and Sequoia stabilization units 1–6 complete; Band 4A measurement is next**
...
Current verified quality baseline: 672 package tests (13 model-gated), zero
...
**Next slice:** Band 4A establishes a measured long-meeting/large-library and
SwiftUI update baseline before any detail decomposition, cache, DatabasePool,
vector, or Spotlight-outbox change.
...
| Band 4 — Detail/performance | Not started; 4A measurement is next | Existing benchmarks in spec 08 plus scoped observation architecture | Establish long-meeting, 1k/10k/50k/100k-segment, and SwiftUI update baselines before selecting changes |
