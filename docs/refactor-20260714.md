...
Status: **approved direction; Bands 0–2 complete, Band 3 in progress; slices 3A–3D complete and 3E next**
...
Current verified quality baseline: 609 package tests (13 model-gated) and 20 XCUITest cases
...
**Slice 3E is next:** characterize Companion generation and adopt provenance
without weakening its degradable live/post-Refine behavior or reviewable-card
persistence. Later slices handle remaining generated artifacts, egress, privacy
receipt, diagnostics, and the sandbox spike.
...
| Band 3 — Provenance/privacy | In progress — slices 3A–3D complete (D62–D65) | Manual/post-refine, durable post-capture, and external-audio import summary attempts plus accepted refined transcripts persist content-free terminal provenance. Durable success shares the job's lease/revision fence; import success shares the immutable summary transaction after the required aggregate commits; Refine success shares accepted transcript publication and links every new segment. No-attempt/cache/discard/stale paths create no orphaned success; failure, cancellation, mismatch, rollback, and real worker/import/Refine Store paths are characterized | Slice 3E: adopt Companion provenance without weakening degradable card generation |
