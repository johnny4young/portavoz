...
default. Private bytes enter a private `0600` sibling and synchronize; complete
protection is then applied and verified before one same-volume atomic rename,
so partial or unprotected content never occupies the reader-visible path.
