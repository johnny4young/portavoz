...
Current verified quality baseline: 714 package tests (13 model-gated), zero
strict-lint violations across 262 Swift source files, and 28 XCUITest cases
...
4. **5D next:** characterize summary decisions and extend the typed
   source-revision/evidence contract to them before action items or cards.
...
| Band 5 — Evidence/people | In progress — 5A, 5B, and 5C complete (D86/D87/D88) | Schema v8 canonical people/aliases, schema v9 typed overview claims/ordered segment links, and schema v10 active-claim-fenced correction/unsupported feedback; explicit identity confirmation; exact E-tag admission; source-revision, tombstone, deletion, text-erasing clear, portable bundle remapping, and model/diagnostics isolation; transcript/audio navigation and reversible review; Core/Storage/Intelligence/UI plus EN/ES coverage | 5D: characterize and add typed decision evidence before action items or Companion cards |
