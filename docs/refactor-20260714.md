...
default. Private bytes enter an empty protected sibling, synchronize, and
publish through one same-volume atomic rename; partial or unprotected content
never occupies the reader-visible path. Matching records retain system fields, malformed records fail closed,
