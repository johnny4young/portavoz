...
Current verified quality baseline: 903 package tests (13 model-gated), zero
strict-lint violations across 328 Swift source files, and 37 XCUITest cases
...
**Next macOS conformance gate:** extract local voice enrollment,
calendar-backed speaker naming, and local-provider discovery that still
coordinate capture, attendee evidence, models, or provider probing in SwiftUI.
...
10. **Resolved by D98–D105 for adopted interfaces:** resident menu-bar reads use one scoped
    ...
    concrete biometric adapters at composition. Local enrollment, speaker
