...
Current verified quality baseline: 527 package tests (13 model-gated) and 19 XCUITest cases
...
4. 🔄 Extract recording, stop, recovery, refine, import, and regeneration use
   ...
   `RecoverInterruptedMeetings` is the next bounded workflow (D44–D49).
