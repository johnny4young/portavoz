...
Current storage schema: `v13`

Current verified quality baseline: 740 package tests (13 model-gated), zero
strict-lint violations across 270 Swift source files, and 31 XCUITest cases
...
**Next program gate:** keep Band 6 platform expansion deferred until a separate
product decision. Real-model evidence quality and next-release field checks are
validation work, not permission to start CloudKit or iOS architecture. Detail
