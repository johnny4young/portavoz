...
Current verified quality baseline: 968 package tests (13 model-gated), zero
strict-lint violations across 343 Swift source files, and 39 XCUITest cases
...
default. Matching records retain system fields, malformed records fail closed,
