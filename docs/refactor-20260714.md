...
Current verified quality baseline: 918 package tests (13 model-gated), zero
strict-lint violations across 331 Swift source files, and 39 XCUITest cases
...
**Next macOS conformance gate:** extract local-provider discovery that still
coordinates provider probing beside presentation.
Preserve direct construction in executable
composition, live capture, diagnostics, and benchmark harnesses. The later 6D gate remains the
