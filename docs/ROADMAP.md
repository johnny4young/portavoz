...
- **M9 PUBLICADO (10 jul 2026)** 🎉: repo público en github.com/johnny4young/portavoz, release v0.1.0 (DMG firmado+notarizado+grapado, `spctl: Notarized Developer ID`; appcast de Sparkle adjunto y alcanzable) y tap `johnny4young/homebrew-portavoz` (`brew install --cask portavoz` con audit limpio). Barrido de sensibilidad pre-publicación: fixtures del entorno de trabajo reemplazados por universo ficticio. Siguiente foco: growth OSS (README/discoverability) + verificación de campo continua.
