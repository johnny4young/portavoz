...
- **Deuda menor viva**: política de micro-clusters de diarización a evaluar contra el RTTM corregido; `meetings refine` podría aceptar `--threshold`. (FluidAudio re-pineado a `.upToNextMinor(from: "0.15.5")` — T9 resuelto jul 2026.)
