...
- **Siguiente paso concreto → M9 (publicación)**, la única brecha de impacto 1 (GAPS #1) y bloqueante de crecimiento. La **preparación interna ya está hecha** (jul 2026): README con benchmarks reproducibles ✅, SwiftLint (config calibrada + job de CI) ✅, issue/PR templates ✅, SECURITY.md/LICENSE/CONTRIBUTING ✅, **localización EN/ES con String Catalogs + selector de idioma** ✅. Lo que **falta** son las **acciones públicas irreversibles** que requieren tu autorización explícita: `git push` a `git@github.com:johnny4young/portavoz.git`, `gh release create v0.1.0 dist/release/*`, y el tap `johnny4young/homebrew-portavoz` con `dist/release/portavoz.rb`.
