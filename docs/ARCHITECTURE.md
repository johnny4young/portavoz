...
to 15.66 MiB. D83 therefore retains exact Float32 BLOBs, schema v7,
`DatabaseQueue`, and the MIT/no-GPL dependency set; sqlite-vec and
...
lexical, semantic, waveform, and Spotlight acceptance evidence. The current
gate is 690 package tests (13 gated), zero strict-lint violations across 256
Swift source files, and 25 XCUITest cases passing in both English and Spanish. Throwaway
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the current 690-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
