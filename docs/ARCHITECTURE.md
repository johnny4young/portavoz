...
into the current schema v13), `DatabaseQueue`, and the MIT/no-GPL dependency set; sqlite-vec and
...
navigation. The current gate is 740 package tests (13 gated),
zero strict-lint violations across 270 Swift source files, and 31
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the current 740-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
