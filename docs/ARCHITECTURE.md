...
behavioral coverage. The current gate is 617 package tests (13 gated), zero
strict-lint violations across 233 Swift source
...
paths create no durable run (D62–D66).
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the 617-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
