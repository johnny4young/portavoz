...
Band 6C1 adds ten lifecycle/journal tests plus one architecture ratchet for
local-only launch privacy, explicit opt-in/seed separation, account loss and
switches, truthful phases, retry preservation, pause/remove-device semantics,
typed fail-closed capability errors, and observable pending generations.
The current gate is 793 package tests (13 gated), zero strict-lint violations
across 286 Swift source files, and 31
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the current 793-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
