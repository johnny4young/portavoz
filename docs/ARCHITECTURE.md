...
Band 2 slices 2A–2Q establish and exercise a dependency, feature-state, and
...
DiarizationKit are admitted only with real vertical use cases. Eighteen
architecture tests parse the real target declarations and source imports. They prevent capability Kits from
...
again. The current gate is
576 package tests (13 gated), zero strict-lint
violations across 223 Swift files, and 20 XCUITest cases.
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the 576-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
