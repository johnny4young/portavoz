...
surface regression test. The current gate is 596 package tests (13 gated), zero
strict-lint violations across 229 Swift
...
|---|---|---|
| 0 — Integrity and truth | Complete — slices 0A/0B: strict decoding, live-meeting aggregate scope, independent language policies; retained by the 596-test package baseline | Strict identity decoding, live-meeting aggregate scope, explicit transcript/summary language policies |
...
| 3 — Provenance and privacy | Next — slice 3A adopts the schema-v6 `generationRun` envelope for one summary workflow before expanding to other generated artifacts | Generation provenance adoption, egress gateway, privacy receipt, typed errors and diagnostics |
