...
| Semantic retrieval through 100k embedded segments | p95 < 100 ms | ✅ historical D83 wall/CPU p95 **90.22/91.26 ms**, down from 325.41/328.43 ms through streamed zero-copy Accelerate scoring and bounded exact top-k; **8.42 MiB incremental p95**. D345 classifies the later 92.85 ms artifact as not directly comparable to this schema-1 run because neither retained complete run identity; the current mapped-control result is documented separately under D318 |
