...
### Portable capture evidence (D482)

The optional validated Meeting-root capture report travels through existing
format-v1 bundle encoding/remapping and the private-sync aggregate. Old bundles
decode with unknown capture evidence, not a complete-recording claim. No raw
