...
Status: the host-independent package gate executes 1,626 cases with zero
failures (15 environment-gated cases skipped) + 57 XCUITest
UI cases. CI
on GitHub Actions
...
The current field-reliability gate is 1,626 XCTest package cases with zero
failures (15 environment-gated cases skipped), zero
strict-lint violations across 473 production Swift files, a 108-case
