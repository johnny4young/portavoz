...
Status: the package inventory contains 2,600 cases (15 environment-gated) + 103
...
| SkillActivityPresentationStateTests | Matching- and mismatched-scope loading, same-scope stale-row suppression, receipt-only unavailability, mutually exclusive verified empty/receipt presentation, and the bounded 20-to-50 history-window transition plus scope reset |
