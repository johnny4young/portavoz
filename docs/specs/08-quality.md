...
Status: 1,323 package tests passing (13 model-gated) + 55 XCUITest UI cases. CI
on GitHub Actions
...
and recovery. It runs 112 focused tests across callback liveness, start/stop,
...
and preserved on failure. The complete 25-iteration gate (2,800 test
