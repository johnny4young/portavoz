...
Status: 1,143 package tests passing (13 model-gated) + 44 XCUITest UI cases. CI
on GitHub Actions
...
and Spanish release gates each cover all 44 cases and retain app-only
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 44 UI
...
recording/recovery corpus passing 25 consecutive iterations, and 44 XCUITest
