...
| MeetingStoreTests summary history/evidence | Per-recipe immutable versions, newest-across-recipe selection, retained history, fingerprint cache/pivots, atomic same-meeting claim validation, revision stamping/staleness, physical-deletion unavailability, and rollback on foreign evidence |
