...
The current inventory is 84 cases per locale (168 bilingual). The Aug 7 cost
sample above predates twenty of those bilingual executions and remains a timing model,
