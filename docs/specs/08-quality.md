...
above it. Both directions derive a vertical-only distance from actual frames
and require hittability before clicking; implicit offscreen clicks can issue diagonal
