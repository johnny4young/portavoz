...
Status: 986 package tests passing (13 model-gated) + 41 XCUITest UI cases. CI
on GitHub Actions
...
| AudioCaptureTests | CaptureFileWriter staging CAF, atomic no-overwrite publication, persisted-PCM recovery measurement, complete checksum/media/health evidence, drift summary, callback-liveness policy, mic-heartbeat stall/retry/recovery integration, recoverable-source invocation, Downmix, **Resample.linear**, startup cleanup |
