...
Meeting Detail tests. The English and Spanish release gates each cover all 80
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 80 UI
...
The current inventory is 80 cases per locale (160 bilingual). The Aug 7 cost
