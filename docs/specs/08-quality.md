...
Status: 978 package tests passing (13 model-gated) + 40 XCUITest UI cases. CI
on GitHub Actions
...
and Spanish release gates each cover all 40 cases and retain app-only
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 40 UI
