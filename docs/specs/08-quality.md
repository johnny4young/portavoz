...
Status: the package inventory contains 2,439 cases (14 environment-gated) + 90
...
Meeting Detail tests. The English and Spanish release gates each cover all 90
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 90 UI
