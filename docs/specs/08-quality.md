...
Status: the package inventory contains 2,365 cases (14 environment-gated) + 79
...
Meeting Detail tests. The English and Spanish release gates each cover all 79
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 79 UI
...
The 11 Aug 2026 development inventory is 2,365 XCTest package cases (14
environment-gated), zero strict-lint violations across 654 production Swift
files, a 221-case recording/recovery selector passing 25 consecutive iterations
(5,525 executions), 354 deterministic tooling cases, and 79 XCUITest cases per
...
The current inventory is 79 cases per locale (158 bilingual). The Aug 7 cost
