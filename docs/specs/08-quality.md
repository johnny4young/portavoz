...
Meeting Detail tests. The English and Spanish release gates each cover all 77
...
`scripts/ui_test_scope.py` is the executable PR-impact policy for all 77 UI
...
The current inventory is 77 cases per locale (154 bilingual). The Aug 7 cost
