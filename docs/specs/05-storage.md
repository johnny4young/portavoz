...
whole-library open-format source (D99/D181–D188). StorageKit copies the live database
...
relaunch continuation. ApplicationKit persists this cursor only after a
publication or typed failure outcome is durable; launch orchestration does not
consume it for stage adoption yet.
