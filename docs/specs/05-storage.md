...
whole-library open-format source (D99/D181–D185). StorageKit copies the live database
...
without deleting the workspace. This is the StorageKit prerequisite for
relaunch continuation; the application recovery journal does not persist or
consume the cursor yet.
