...
whole-library open-format source (D99/D181/D182/D183). StorageKit copies the live database
...
root is excluded from backup. A current-format workspace retains an exclusive
...
non-symlink owner file can be locked nonblockingly. A live owner and unknown
legacy shape are preserved fail-closed.
