...
- Everything described in the regular sections **is implemented and tested** (`swift test`, 440 tests, 13 gated by `PORTAVOZ_MODEL_TESTS=1` or other integration variables).
