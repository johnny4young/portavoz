...
- Everything described in the regular sections **is implemented and tested** (`swift test`, 1,241 XCTest cases, 13 gated by `PORTAVOZ_MODEL_TESTS=1` or other integration variables).
