...
- Everything described in the regular sections **is implemented and tested** (`swift test`, 449 tests, 13 gated by `PORTAVOZ_MODEL_TESTS=1` or other integration variables).
...
- [../DECISIONS.md](../DECISIONS.md) — binding decisions D1–D43 and their rationale. The specs cite them by number.
