...
- Todo lo descrito en las secciones normales **está implementado y testeado** (`swift test`, 248 tests, 12 gated por `PORTAVOZ_MODEL_TESTS=1` u otras variables de integración).
