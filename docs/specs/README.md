...
- Everything described in the regular sections **is implemented and tested** (`swift test`, 1,292 XCTest cases, 13 gated by `PORTAVOZ_MODEL_TESTS=1` or other integration variables).
...
- [../DECISIONS.md](../DECISIONS.md) — binding decisions D1–D161 and their rationale. The specs cite them by number.
