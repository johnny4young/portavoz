...
post-capture summary generation uses background priority. `MLXModelCache`
continues to own verified model/container lifetime and idle release, not
scheduling.
