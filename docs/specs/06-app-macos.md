...
### Capture-safe staged whole-library backup (D180/D181)
...
mid-export pause, not relaunch durability: destination authorization, a
publication manifest, collision reservations, and abandoned-stage recovery
remain required before a terminated app can continue the same backup.
