...
### Capture-safe staged whole-library backup (D180–D183)
...
Bookmark bytes remain only in the active actor. Persistent authorization, a
publication manifest, collision reservations, and stage adoption remain
required before a terminated app can continue the same backup.
