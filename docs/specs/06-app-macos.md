...
### Capture-safe staged whole-library backup (D180–D182)
...
composition never scans the host root. Destination authorization, a publication
manifest, collision reservations, and stage adoption remain required before a
terminated app can continue the same backup.
