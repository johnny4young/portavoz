...
Web is visibly unavailable and cannot submit until its separate adapter exists;
it never falls back to Library. The command palette stays visibly Library-only.
