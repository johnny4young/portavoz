...
### Capture-safe staged whole-library backup (D180–D186)
...
The persisted reservation and cursor narrow the move/source crash windows, but
the app does not yet reconcile pending destination bytes or invoke staged-source
adoption at launch. Launch cleanup still discards an abandoned stage and its
matching journal rather than adopting it. Full relaunch continuation therefore
remains unclaimed.
