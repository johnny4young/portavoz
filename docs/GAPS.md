...
| 12 | The Automation center still lacks most workflow actions | **Partial (D317/D335–D338):** Skills Settings owns durable pause/enablement, indexed Recent/Waiting/Attention/Completed execution scopes, content-free causal receipt inspection, and a bounded Proposed queue with typed why/input explanations plus durable dismissal by unrelated review UUID. Failed mutations retain the row and stale producers/open confirmations cannot override a committed dismissal. | Proposed rows intentionally cannot confirm in Settings; receipts cannot retry/revoke an eligible workflow; user-authored standing rules remain absent. Exact preview and confirmation stay on the original subject surface. | Continue AUTO-6 receipt/proposal actions before any AUTO-5 standing rules |
