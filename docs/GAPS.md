...
| 12 | The Automation center reviews executions but not proposals | **Partial (D317/D335/D336):** Skills Settings owns durable pause/enablement, indexed Recent/Waiting/Attention/Completed execution scopes, and content-free causal receipt inspection. Scope failures cannot relabel stale rows or disable independently verified policy. | Proposed offers still have no central durable owner, so Settings cannot honestly explain why an offer appeared or what exact data it will use. Receipt-level retry/dismiss/revoke actions and user-authored standing rules also remain absent. | AUTO-6 central proposal authority and explanation before any AUTO-5 standing rules |
