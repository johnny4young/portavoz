...
| 12 | The Automation center still lacks most workflow actions | **Partial (D317/D335–D340):** Skills Settings owns durable pause/enablement, indexed Recent/Waiting/Attention/Completed execution scopes, content-free causal receipt inspection, a bounded Proposed queue with typed why/input explanations plus durable dismissal, opaque review-in-context routing for meeting/commitment offers, and proposal-UUID-only revocation while an execution is still durably Waiting. Failed actions retain their row, stale producers/open confirmations cannot override a committed dismissal, and begin/revoke has one SQLite-serialized winner. | Proposed rows intentionally cannot confirm in Settings; calendar review remains resident in the menu bar because SwiftUI exposes no public opener; a content-free failed receipt cannot safely reconstruct or retry its exact effect; user-authored standing rules remain absent. Exact preview and confirmation stay on the original subject surface. | Continue AUTO-6 workflow actions before any AUTO-5 standing rules |
