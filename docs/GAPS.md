...
| 12 | The Automation center has read-only review but no workflow actions | **Partial (D317/D335–D337):** Skills Settings owns durable pause/enablement, indexed Recent/Waiting/Attention/Completed execution scopes, content-free causal receipt inspection, and a bounded content-free Proposed queue that explains typed why/input categories from the real producer authority. Independent failures never invent rows or disable separately verified policy. | Proposed rows cannot confirm or dismiss from Settings, receipts cannot retry/revoke an eligible workflow, and user-authored standing rules remain absent. Exact preview and confirmation intentionally stay on the original subject surface. | Continue AUTO-6 workflow actions before any AUTO-5 standing rules |
