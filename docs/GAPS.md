...
| T15 | Broad app invalidation and orchestration concentration | unrelated screens reload and workflows remain difficult to isolate/test | **Next:** refactor Band 2, beginning with the `ApplicationKit` dependency shell and architecture rule tests |
