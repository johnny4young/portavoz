...
DEFAULT_FILTER='AudioInputFormatPolicyTests|AudioRouteTransitionGateTests|CaptureFileWriterTests|RecordingSummaryTests|SystemCaptureLivenessPolicyTests|DownmixTests|ResampleTests|RecordingLevelBufferTests|RecordingLevelRelayTests|StartRecordingUseCaseTests|StopRecordingUseCaseTests|RecoverInterruptedMeetingsUseCaseTests|LiveTranscriptionAttacherTests|RecordingPersistenceTests|ProcessingJobPersistenceTests|ProcessPostCaptureJobsUseCaseTests|InitialTranscriptionOperationFingerprintTests|CaptionCoalescerTests'
