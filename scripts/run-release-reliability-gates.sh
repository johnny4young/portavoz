...
LANGUAGE_FILTER='CaptionCoalescerTests|CaptionCoalescerNoiseTests|CaptionCoalescerOverlapTests|MicBleedFilterTests|LiveCaptionParagraphProjectorTests|LiveTranslationRoutingTests|LiveTranslationStateTests|SpokenLanguageDetectorTests|ModelCatalogTests|RefineMeetingUseCaseTests'
UI_TESTS='PortavozUITests/LibraryUITests/testRecordingWarnsWhenRemoteAudioCallbacksStop PortavozUITests/LibraryUITests/testColdRecordingStartsLiveCaptionsWhenModelBecomesReady PortavozUITests/LibraryUITests/testLiveTranscriptYieldsFollowWhileReadingHistory PortavozUITests/LibraryUITests/testLiveTranslationUsesADistinctLabeledRail PortavozUITests/MeetingDetailUITests/testRunningRefineCanBeCanceledWithoutChangingTheTranscript PortavozUITests/SettingsUITests/testCategoryNavigationRevealsEachPane'
