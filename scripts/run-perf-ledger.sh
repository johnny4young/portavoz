...
HOST_SAMPLE_INTERVAL_SECONDS="${PORTAVOZ_PERF_HOST_SAMPLE_INTERVAL_SECONDS:-2}"
HOST_REQUIRED_CONSECUTIVE_SAMPLES="${PORTAVOZ_PERF_HOST_REQUIRED_CONSECUTIVE_SAMPLES:-3}"
